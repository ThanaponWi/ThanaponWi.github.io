    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerUniversity.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(MainActivity.this,clickedUniName+" selected",Toast.LENGTH_SHORT).show();
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(MainActivity.this,"Please Choose University",Toast.LENGTH_SHORT).show();
            }
        });
        //listview
        ListView = (ListView)findViewById(R.id.list_item);
        //adapter
        ListAdapter adapter = new ListAdapter(MainActivity.this,busList);
